$(function(){
     ...
     setTimeout(function(){
        $("#cart-items").slideUp();
			...
			//add items to basket
			$(this).each(function () {
				var name = $(this).children(".content").children("h4").text();
				var remove = "<button class='remove'> X </button>";
				var cena = "<span class='eachPrice'>" + (parseFloat($(this).children(".content").children(".prices").children(".price").text())) + "</span>";
